...
import { FormControl} from '@presentation/views/control';
import { useEffect } from "react";

/**
 * Componente `HomeControl`.
 * 
 * Este componente es responsable de la vista principal del control de caldad en la aplicación.
  ...
  const navigate = useNavigate();
    ...
    return (
        ...
        <UtilsCoreTabMenu 
            ...
            useRoutes={useRoutes}
            navigate={navigate}
            viewForm={<FormControl navigate={navigate}/>}
            viewGrid={''}
            init={initial}
